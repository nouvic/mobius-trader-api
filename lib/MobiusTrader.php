...
use MobiusTraderLibs\MobiusTraderClient;
use MobiusTraderLibs\MobiusTraderCache;
use MobiusTraderLibs\MobiusTraderSearch;
...
class MobiusTrader
{
    ...
    {
        $this->_config = $config;
        $this->_cache = new MobiusTraderCache($config);
        $this->_client = new MobiusTraderClient($config);
    }
    ...
    {
        return new MobiusTraderSearch($this->_client, func_get_args());
    }

    public function search_array(array $columns)
    {
        return new MobiusTraderSearch($this->_client, $columns);
    }

    public static function expr($string)
    {
        return MobiusTraderSearch::expr($string);
    }
